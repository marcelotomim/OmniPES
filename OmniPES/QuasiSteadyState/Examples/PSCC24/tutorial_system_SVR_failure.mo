...
model tutorial_system_SVR_failure
  ...
  OmniPES.QuasiSteadyState.Machines.GenericSynchronousMachine G2(redeclare OmniPES.QuasiSteadyState.Examples.PSCC24.Controllers.AVR_SRV avr,redeclare OmniPES.QuasiSteadyState.Machines.Interfaces.Model_2_1_Electric electrical, redeclare OmniPES.QuasiSteadyState.Controllers.PSS.NoPSS pss, redeclare OmniPES.QuasiSteadyState.Machines.Interfaces.Restriction_P restriction, smData = G2_data, specs = G2_pf_data, redeclare OmniPES.QuasiSteadyState.Examples.PSCC24.Controllers.SpeedGovernor sreg)  annotation(
    Placement(visible = true, transformation(origin = {-124, 50}, extent = {{-14, -14}, {14, 14}}, rotation = 180)));
  OmniPES.QuasiSteadyState.Machines.GenericSynchronousMachine G1(redeclare OmniPES.QuasiSteadyState.Examples.PSCC24.Controllers.AVR_SRV avr,redeclare OmniPES.QuasiSteadyState.Machines.Interfaces.Model_2_1_Electric electrical, redeclare OmniPES.QuasiSteadyState.Controllers.PSS.NoPSS pss, redeclare OmniPES.QuasiSteadyState.Machines.Interfaces.Restriction_VTH restriction,smData = G1_data, specs = G1_pf_data, redeclare OmniPES.QuasiSteadyState.Examples.PSCC24.Controllers.SpeedGovernor sreg)  annotation(
    Placement(visible = true, transformation(origin = {-124, -40}, extent = {{-14.5, -14.5}, {14.5, 14.5}}, rotation = 180)));
  ...
  OmniPES.QuasiSteadyState.Examples.PSCC24.Controllers.Plant_SVR g1_srv annotation(
...
equation
  ...
  G1.avr.Vext = 0*g1_srv.Vref + central_SVR.Vref;
  G2.avr.Vext = g2_srv.Vref + central_SVR.Vref;
  g1_srv.Qcom = 0*central_SVR.Qout[1];
  g1_srv.Qt = 0*G1.electrical.Qt;
  ...
  connect(G1.terminal, bus_1.p) annotation(
    Line(points = {{-109.5, -40}, {-90, -40}}, color = {0, 0, 255}));
...
end tutorial_system_SVR_failure;