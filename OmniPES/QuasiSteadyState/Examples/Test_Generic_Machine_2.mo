...
model Test_Generic_Machine_2
  ...
  parameter OmniPES.QuasiSteadyState.Machines.RestrictionData gen1_specs(Psp = 80., Qsp = 0, Vsp = 1.05) annotation(
  ...
  parameter OmniPES.QuasiSteadyState.Machines.RestrictionData gen2_specs(Psp = 0., Qsp = 0, Vsp = 1.0, theta_sp = 0) annotation(
    Placement(visible = true, transformation(origin = {-50, 50}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
