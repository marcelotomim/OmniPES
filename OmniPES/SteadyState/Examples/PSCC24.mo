...
package PSCC24
  model tutorial_system
    ...
    OmniPES.SteadyState.Sources.VTHSource_Qlim G1(Qmax = 26, Vsp = 1.017) annotation(
  ...
  Modelica.Blocks.Math.Gain gain(k = 3/4)  annotation(
      Placement(visible = true, transformation(origin = {-186, 30}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  equation
  ...
  connect(gain.y, G2.DPsp) annotation(
      Line(points = {{-175, 30}, {-158, 30}}, color = {0, 0, 127}));
  connect(gain.u, ramp_P.y) annotation(
      Line(points = {{-198, 30}, {-216, 30}, {-216, -104}, {-228, -104}}, color = {0, 0, 127}));
