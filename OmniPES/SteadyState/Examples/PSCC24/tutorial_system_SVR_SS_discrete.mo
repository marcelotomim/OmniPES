...
model tutorial_system_SVR_SS_discrete
  extends tutorial_system_SVR_SS(redeclare OmniPES.SteadyState.Sources.VTHSource_Qlim_sigmoid G1, redeclare OmniPES.SteadyState.Sources.PVSource_Qlim_discrete G2);
  annotation(
