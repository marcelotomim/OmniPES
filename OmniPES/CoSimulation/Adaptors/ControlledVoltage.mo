...
//  Modelica.Blocks.Interfaces.RealOutput Ir annotation(
  ...
  Modelica.Blocks.Interfaces.RealOutput Ir annotation(
    Placement(visible = true, transformation(origin = {110, 80}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-80, -110}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
Modelica.Blocks.Interfaces.RealOutput Ii annotation(
    Placement(visible = true, transformation(origin = {110, 40}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-42, -110}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
equation
  v = Complex(Vr, Vi);
  i = -Complex(Ir, Ii);
//dIr = der(i.re);
//dIi = der(i.im);
  annotation(
    Icon(graphics = {Ellipse(extent = {{-50, 50}, {50, -50}}), Line(origin = {-75, 0}, points = {{25, 0}, {-25, 0}, {-25, 0}}), Line(origin = {65, 0}, points = {{-15, 0}, {15, 0}, {15, 0}}), Rectangle(origin = {-0.00942045, 0.0664522}, extent = {{-100.009, 100.066}, {100.009, -100.066}}), Line(origin = {81.5, 0}, points = {{-1.2, 20}, {-1.2, -20}}), Line(origin = {87.5, 0}, points = {{-1.2, 15}, {-1.2, -15}}), Line(origin = {93.5, 0}, points = {{-1.2, 10}, {-1.2, -10}}), Text(origin = {-36, 0.6}, extent = {{-20, 20}, {20, -20}}, textString = "+"), Text(origin = {42, 0}, rotation = 90, extent = {{-20, 20}, {20, -20}}, textString = "-")}, coordinateSystem(extent = {{-100, -100}, {100, 100}})));
