...
model Generic_Machine
  ...
  parameter OmniPES.Transient.Machines.RestrictionData gen1_specs(Psp = 50)  annotation(
...
equation
//controlledVoltage1.Vi = 0;
//controlledVoltage1.Vr = if time < 0.1 then 1 else 0.95;
