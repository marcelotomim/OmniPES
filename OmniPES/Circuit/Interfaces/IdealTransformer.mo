...
equation
  ...
  n.i + a*p.i = Complex(0);
  annotation(
    Icon(graphics = {Line(origin = {72, 0}, points = {{-27, 0}, {30, 0}}), Line(origin = {-72, 0}, points = {{-30, 0}, {27, 0}}), Ellipse(origin = {-17, 0}, extent = {{-28, 28}, {28, -28}}), Ellipse(origin = {17, 0}, extent = {{-28, 28}, {28, -28}}), Ellipse(origin = {-48, 28}, fillPattern = FillPattern.Solid, extent = {{-4, 4}, {4, -4}}), Text(origin = {0, 80}, extent = {{-100, 20}, {100, -20}}, textString = "1:%a", fontSize = 8)}, coordinateSystem(extent = {{-100, -100}, {100, 100}}, grid = {1, 1})),
