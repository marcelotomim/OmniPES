...
connector NegativePin
  ...
  annotation(
    ...
    Diagram(coordinateSystem(preserveAspectRatio = true, extent = {{-100, -100}, {100, 100}}), graphics = {Rectangle(lineColor = {0, 0, 255}, fillColor = {255, 255, 255}, fillPattern = FillPattern.Solid, extent = {{-40, 40}, {40, -40}}), Text(origin = {0, 72}, textColor = {26, 95, 180}, extent = {{-100, 30}, {100, -30}}, textString = "%name", fontSize = 8)}));
end NegativePin;