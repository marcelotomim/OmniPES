...
model Test_Classical_Machine_3
  ...
  parameter OmniPES.Transient.Machines.SynchronousMachineData gen1_data(D = 0, H = 5, MVAb = 100, Nmaq = 1, Ra = 0.0, X1d = 0.2, X1q = 0.2, Xd = 1.0, Xl = 0.0, Xq = 0.8) annotation(
    Placement(visible = true, transformation(origin = {50, 50}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  parameter OmniPES.Transient.Machines.RestrictionData gen1_specs(Psp = 80., Qsp = 0, Vsp = 1.0) annotation(
    Placement(visible = true, transformation(origin = {10, 50}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  //
  OmniPES.Transient.Machines.ClassicalSynchronousMachine SM(redeclare OmniPES.Transient.Machines.Interfaces.Restriction_PV restriction, smData = gen1_data, specs = gen1_specs) annotation(
