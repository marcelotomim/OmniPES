...
model tutorial_system_SVR_QSS
  ...
  OmniPES.Transient.Examples.PSCC24.Controllers.Plant_SVR g1_srv(init = Modelica.Blocks.Types.Init.SteadyState)  annotation(
    Placement(visible = true, transformation(origin = {-232.5, -40.5}, extent = {{-13.5, -13.5}, {13.5, 13.5}}, rotation = 0)));
  OmniPES.Transient.Examples.PSCC24.Controllers.Plant_SVR g2_srv annotation(
