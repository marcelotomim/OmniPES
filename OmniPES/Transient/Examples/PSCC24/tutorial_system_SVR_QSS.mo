...
model tutorial_system_SVR_QSS
  ...
  parameter OmniPES.Transient.Machines.SynchronousMachineData G2_data(H = 3.0e7, MVAb = 150, T1d0 = 9.0, T1q0 = 0, T2d0 = 0.025, T2q0 = 0.08, X1d = 0.4, X1q = 0, X2d = 0.25, X2q = 0.25, Xd = 1.4, Xl = 0.15, Xq = 0.75, D = 2) annotation(
    Placement(transformation(origin = {-101, 41}, extent = {{-10, -10}, {10, 10}})));
  parameter OmniPES.Transient.Machines.SynchronousMachineData G1_data(H = 3e7, MVAb = 50, T1d0 = 9.0, T1q0 = 0, T2d0 = 0.025, T2q0 = 0.08, X1d = 0.4, X1q = 0, X2d = 0.25, X2q = 0.25, Xd = 1.4, Xl = 0.15, Xq = 0.75, D = 2) annotation(
