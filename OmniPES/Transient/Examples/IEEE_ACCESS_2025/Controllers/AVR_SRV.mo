...
model AVR_SRV
 ...
 Modelica.Blocks.Sources.RealExpression VCTRL(y = Vctrl) annotation(
    Placement(transformation(origin = {-109, 27}, extent = {{-10, -10}, {10, 10}})));
 Modelica.Blocks.Sources.RealExpression VSAD(y = Vsad) annotation(
    Placement(transformation(origin = {-110, 55}, extent = {{-10, -10}, {10, 10}}))); equation
  ...
  connect(sum1.y, limIntegrator.u) annotation(
    Line(points = {{-35, 0}, {-1, 0}}, color = {0, 0, 127}));
 ...
 connect(VCTRL.y, sum1.u[1]) annotation(
    Line(points = {{-98, 28}, {-68, 28}, {-68, 0}, {-58, 0}}, color = {0, 0, 127}));
 connect(VSAD.y, sum1.u[2]) annotation(
    Line(points = {{-98, 56}, {-62, 56}, {-62, 0}, {-58, 0}}, color = {0, 0, 127}));
  annotation(
