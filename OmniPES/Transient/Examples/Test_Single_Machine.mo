...
model Test_Single_Machine
  ...
  parameter Transient.Machines.RestrictionData gen1_specs(Psp = 0.9*100, Qsp = 0.4*100, Vsp = 1.0, theta_sp = 0) annotation(
  ...
  //
  Transient.Machines.GenericSynchronousMachine SM(smData = gen1_data, specs = gen1_specs, redeclare OmniPES.Transient.Machines.Interfaces.Model_2_2_Electric electrical(is_saturable = true, redeclare OmniPES.Transient.Machines.SaturationFunctions.Exponential_2 sat_d), redeclare OmniPES.Transient.Machines.Interfaces.Restriction_PQ restriction, redeclare FieldStep avr, redeclare Transient.Controllers.PSS.NoPSS pss, redeclare Transient.Controllers.SpeedRegulators.ConstantPm sreg) annotation(
...
equation
  connect(SM.terminal, bus3.p) annotation(
