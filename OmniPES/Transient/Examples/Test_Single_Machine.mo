...
model Test_Single_Machine
  ...
  parameter Transient.SynchronousMachines.RestrictionData gen1_specs(Psp = 0.9*100, Qsp = 0.5*100, theta_sp = 0) annotation(
  ...
  parameter Transient.SynchronousMachines.SynchronousMachineData gen1_data(D = 0, H = 6.5, Nmaq = 1, Ra = 0, T1d0 = 8, T1q0 = 0.4, T2d0 = 0.03, T2q0 = 0.05, X1d = 0.3, X1q = 0.55, X2d = 0.25, X2q = 0.25, Xd = 1.8, Xl = 0.2, Xq = 1.7, MVAb = 100) annotation(
