...
model Test_Generic_Load
  ...
  OmniPES.Circuit.Sources.VoltageSource voltageSource(magnitude = 1.0) annotation(
  ...
  OmniPES.Circuit.Basic.SeriesImpedance impedance(x = 0.1) annotation(
    Placement(visible = true, transformation(origin = {-24, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  parameter OmniPES.Transient.Loads.Interfaces.LoadData dynData(pi = 0, pz = 0, qi = 0, qz = 0) annotation(
    Placement(transformation(origin = {126, -10}, extent = {{-10, -10}, {10, 10}})));
  OmniPES.Circuit.Interfaces.Bus bus annotation(
    Placement(visible = true, transformation(origin = {28, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  OmniPES.Circuit.Basic.SeriesImpedance impedance1(x = 0.10) annotation(
  ...
  Circuit.Switches.Fault fault annotation(
    Placement(transformation(origin = {30, -44}, extent = {{-10, -10}, {10, 10}})));
equation
  ...
  connect(fault.T, bus.p) annotation(
    Line(points = {{30, -34}, {28, -34}, {28, 0}}, color = {0, 0, 255}));
protected
  annotation(
