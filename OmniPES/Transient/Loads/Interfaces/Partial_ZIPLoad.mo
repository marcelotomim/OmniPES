...
equation
  ...
  annotation(
    Icon(graphics = {Text(origin = {1, -14}, extent = {{-55, 40}, {55, -40}}, textString = "%name"), Rectangle(origin = {1, 0.424659}, extent = {{-60, 60.5753}, {60, -60.5753}}), Line(origin = {-81, 0}, points = {{21, 0}, {-19, 0}, {-21, 0}}), Text(origin = {1, -14}, extent = {{-55, 40}, {55, -40}}, textString = "%name"), Text( origin = {0, -100},extent = {{-60, 18}, {60, -18}}, textString = "%Psp
%Qsp", fontSize = 8)}, coordinateSystem(extent = {{-100, -100}, {100, 100}})));
end Partial_ZIPLoad;